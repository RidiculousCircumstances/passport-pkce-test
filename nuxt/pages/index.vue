...
export default {
  ...
  computed: {
    loginUrl() {
      return 'http://localhost:8000/oauth/authorize?client_id=3&redirect_uri=http://localhost:3000/auth&response_type=code&scope=*&state=' + this.state + '&code_challenge=' + this.challenge + '&code_challenge_method=S256'
    }
  },
